...
def test_station_ctrl_pf_import():
    ...
    assert(abs(net.res_bus.loc[62, "vm_pu"] - (1.01 + ((net.res_line.loc[4, "q_to_mvar"] +
                                net.res_line.loc[5, "q_to_mvar"]) / net.controller.object[4].q_droop_mvar))) < tol)
...
def test_pf_control_droop_p():
    ...
    assert(all(net.controller.object[i].converged == True for i in net.controller.index))
    assert(getattr(net.controller.at[0, 'object'].control_modus, 'value', None) == 'PF_ctrl_P_droop')  # test correct control_modus
    assert(getattr(net.controller.at[1, 'object'].control_modus, 'value', None) == 'PF_ctrl_P_droop')  # test correct control_modus
    assert(net.controller.at[1, 'object'].controller_idx == 0)  # test droop controller linkage
...
def test_pf_control_droop_v():
    ...
    assert(all(net.controller.object[i].converged == True for i in net.controller.index))
    assert(getattr(net.controller.at[0, 'object'].control_modus, 'value', None) == 'PF_ctrl_V_droop')  # test correct control_modus
    assert(getattr(net.controller.at[1, 'object'].control_modus, 'value', None) == 'PF_ctrl_V_droop')  # test correct control_modus
    assert(net.controller.at[1, 'object'].controller_idx == 0)  # test droop controller linkage
...
def test_station_ctrl_pf_import_new():
    ...
    assert(getattr(net.controller.at[3, 'object'].control_modus, 'value', None) == 'V_ctrl_Q_droop')  # test correct control_modus
    assert(getattr(net.controller.at[4, 'object'].control_modus, 'value', None) == 'V_ctrl_Q_droop')  # test correct control_modus
    assert(net.controller.at[4, 'object'].controller_idx == 3)  # test droop controller linkage
    print("--------------------------------------")
    print("Scenario 3 - Constant V")
    ...
    assert(getattr(net.controller.at[6, 'object'].control_modus, 'value', None) == 'PF_ctrl_ind')  # test correct control_modus
    print("------------------------------------- ")
    ...
    assert(abs(np.arctan(net.res_line.loc[27, "q_to_mvar"] / net.res_line.loc[27, 'p_to_mw']) - np.arccos(
        droop_set_point)) < tol)
    assert(getattr(net.controller.at[8, 'object'].control_modus, 'value', None) == 'PF_ctrl_V_droop')  # test correct control_modus
    assert(getattr(net.controller.at[9, 'object'].control_modus, 'value', None) == 'PF_ctrl_V_droop')  # test correct control_modus
    ...
    assert(abs(np.arctan(net.res_line.loc[25, "q_to_mvar"] / net.res_line.loc[25, 'p_to_mw']) - np.arccos(
        droop_set_point)) < tol)
    assert(getattr(net.controller.at[10, 'object'].control_modus, 'value', None) == 'PF_ctrl_P_droop')  # test correct control_modus
    assert(getattr(net.controller.at[11, 'object'].control_modus, 'value', None) == 'PF_ctrl_P_droop')  # test correct control_modus
    assert(net.controller.at[11, 'object'].p_cosphi == True)  # correct control_modus
    ...
    assert(getattr(net.controller.at[7, 'object'].control_modus, 'value', None) == 'tan_phi_ctrl')  # test correct control_modus
